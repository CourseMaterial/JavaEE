...
public class SecuredPage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.getWriter().println("Identity " + context.getIdentityToken().getJwtClaims().getStringClaim("email"));
        response.getWriter().println("<br/>");
        response.getWriter().println("<br/>");

        response.getWriter().println("Identity Token " + context.getIdentityToken().getToken());
        response.getWriter().println("<br/>");
        response.getWriter().println("<br/>");
        response.getWriter().println("Access Token" + context.getAccessToken().getToken());
